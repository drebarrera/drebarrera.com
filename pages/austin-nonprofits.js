  ...
  return (
    <article className={`${styles.article}`}>
      <section className={`${styles.section}`}>
        <Image className={`${styles.img}`} src={'/images/nonprofit-atx.png'} width={200} height={200} alt={"Nonprofit-ATX.png"}/>
        ...
        <Link href={"https://www.youtube.com/live/Ix6sBf1bZD4?feature=share"}><div><p>Tech Non-Profit Summit</p></div></Link>
