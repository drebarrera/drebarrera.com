    ...
    return (
        <>
            ...
            <article className={`${styles.frame} ${styles.phasei}`}>
                <div className={styles.breadcrumb}><Breadcrumb breadcrumbArray={{"Andrés Barrera": "/", "Startup Center": "/startups", "Website Development": "/startups/website-development", "Deployment": "/startups/website-development/deployment"}}></Breadcrumb></div>
