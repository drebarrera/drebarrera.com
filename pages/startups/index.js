...
export default function Startups() {
    ...
    <article>
        ...
        <section id="#timeline" className={styles.timeline}>
            ...
            <ol>
                <li>
                    <h5>The Napkin Drawing Concept</h5>
                    <p>This is where all good ideas start! It's the ideation phase where you brainstorm and sketch out your initial concept, perform preliminary market research, and validate your idea. In this stage, you want to start framing out your value proposition, pitch, and target market.</p>
                </li>
            </ol>
        </section>
    </article>
