    ...
    useEffect(() => {
        ...
        script.onload = () => {
            window.trends.embed.renderExploreWidgetTo(trendBox, "TIMESERIES", {
                "comparisonItem":[{"keyword":"nextjs","geo":"","time":"today 5-y"},
                {"keyword":"reactjs","geo":"","time":"today 5-y"},
                {"keyword":"vuejs","geo":"","time":"today 5-y"},
                {"keyword":"angularjs","geo":"","time":"today 5-y"},
                {"keyword":"expressjs","geo":"","time":"today 5-y"}],
                "category":0,
                "property":""
            }, {
                "exploreQuery":"date=today%205-y&q=nextjs,reactjs,vuejs,angularjs,expressjs&hl=en",
